                ...
                <b-card title="Change Password">
                    <validation-observer ref="changePwForm" v-slot="{handleSubmit}">
                        <b-form @submit.prevent="handleSubmit(onSubmit)">
                            <b-row>
                                <validation-provider class="col-12 col-xl-6 col-lg-6" rules="required" v-slot="{errors}" name="current_password">
                            ...
                            <b-row>
                                <validation-provider class="col-12 col-xl-6 col-lg-6"  rules="required|min:6|max:30" v-slot="{errors}" vid="confirmation" name="new_password">
                            ...
                            <b-row>
                                <validation-provider class="col-12 col-xl-6 col-lg-6"  rules="required|min:6|max:30|confirmed:confirmation" v-slot="{errors}" name="new_password_confirmation">
